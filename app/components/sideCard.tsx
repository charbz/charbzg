        ...
        <section>
            <div>
                ...
                <div className="flex justify-between mt-4 mb-2 mx-auto w-[150px] text-[#c3c3c3] dark:text-gray-600 transition-colors duration-300">
                    ...
                    <a href="https://x.com/charbz_g" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500 dark:hover:text-gray-300">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="currentColor">
                            <g><polygon points="12.153992,10.729553 8.088684,5.041199 5.92041,5.041199 10.956299,12.087097 11.59021,12.97345    15.900635,19.009583 18.068909,19.009583 12.785217,11.615906  "/>
